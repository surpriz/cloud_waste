"use client";
  ...
  justify-center">
            ...
            <div className="bg-yellow-900/20 border border-yellow-800/30 rounded-lg p-3 mb-6">
              <p className="text-xs text-yellow-200">
                ⏱️ <strong>Important :</strong> Le lien expire dans 7 jours. Si vous ne vérifiez
  pas votre email, votre compte sera automatiquement supprimé après 14 jours.
              </p>
            </div>
  ...
  "text-green-400" : "text-red-400"}`}>
            ...
            <p className="text-sm text-gray-500 text-center">
              Problème ? <Link href="/auth/login" className="text-blue-400
  hover:text-blue-300">Retour à la connexion</Link>
            </p>
          </div>

    ...
    <div className="relative rounded-2xl bg-white p-10 shadow-2xl border border-gray-100 max-w-md w-full">
      ...
      <div className="relative z-10">
        <div className="mb-8 text-center">
          <div className="inline-flex items-center justify-center h-16 w-16 rounded-2xl bg-gradient-to-br from-green-600 to-blue-600 shadow-lg mb-4">
            <UserPlus className="h-8 w-8 text-white" />
          </div>
          <h1 className="text-4xl font-extrabold bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">
            Join CloudWaste
          </h1>
          <p className="mt-3 text-gray-600 text-lg">Start saving on cloud costs today</p>
        </div>
